...
% h1 = zeros(sample_num, nH);
% h2 = zeros(sample_num, nH);
% s1 = zeros(sample_num, nS);
% s2 = zeros(sample_num, nS);
% v1 = zeros(sample_num, nV);
% v2 = zeros(sample_num, nV);

for i = 1:sample_num
    % convert to hsv format
    image_rgb = imread(['E:/computer_vision_projects/homework_1/vision/',num2str(i),'.png']);
